...
class ImageIndicator(
    ...
    override fun onPageSelected(position: Int) {
        ...
        mContainer.getChildAt(mPreSelectedPosition)
            .setBackgroundResource(getNormalIndicatorResId(mPreSelectedPosition))
    ...
    private fun getNormalIndicatorResId(position: Int): Int =
        mNormalIndicatorResIds[position % mNormalIndicatorResIds.size]

    private fun getSelectedIndicatorResId(position: Int): Int =
        mSelectedIndicatorResIds[position % mSelectedIndicatorResIds.size]
